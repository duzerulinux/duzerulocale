...
class DuzeruLocale:
    ...
    def __init__(self):
        ...
        self.builder.add_from_file('/usr/lib/duzeru/duzeruLocale/add.ui')
        ...
        for line in locales.split("\n"):
            ...
            if locale not in installed:
                ...
                if os.path.exists(flag_path):
                    ...
                    model.set_value(iter, 2, GdkPixbuf.Pixbuf.new_from_file('/usr/share/duzeru/duzeruLocale/flags/16/generic.png'))
    ...
    def button_install_clicked (self, button):
        ...
        if os.path.exists("/var/lib/locales/supported.d"):
        	os.system("localedef --list-archive | sed 's/utf8/UTF-8 UTF-8/g' > /var/lib/locales/supported.d/duzerulocale")
        sys.exit(0)
